...
/***/ function(module, exports, __webpack_require__) {
	...
	var appConfig = __webpack_require__(358);
	var allConfigs = {
		app: appConfig
	};
	...
	for (var i in appConfig.configs) {
		...
		allConfigs[appConfig.configs[i]] = __webpack_require__(359)("./" + appConfig.configs[i]);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extensionsDb = __webpack_require__(357);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsSystemNavigation = __webpack_require__(9);

	var _componentsSystemNavigation2 = _interopRequireDefault(_componentsSystemNavigation);
	  ...
	  */
		...
		_createClass(Context, [{
			...
			value: function initialize(data) {
				...
				for (var i in data.config.storages) {
					for (var a in data.config.storages[i].api) {
						if (!this._api[data.config.storages[i].api[a]]) {
							var ApiClass = __webpack_require__(36)("./" + data.config.storages[i].api[a]);
				...
				this.Navigation = new _componentsSystemNavigation2['default']();
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extensionsEvents = __webpack_require__(35);

	var _extensionsEvents2 = _interopRequireDefault(_extensionsEvents);

	var Navigation = (function (_Events) {
		_inherits(Navigation, _Events);
	  ...
	  */
		...
		_createClass(Navigation, [{
			key: '_prepareConfig',
			value: function _prepareConfig(items, parent) {
				for (var i in items) {
					items[i].id = _underscore2['default'].uniqueId('item-');
	   ...
	   */
			...
			key: '_getNewPrepareConfig',
			value: function _getNewPrepareConfig() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coreApi = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coreStorage = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coreModel = __webpack_require__(42);
