...
/***/ function(module, exports, __webpack_require__) {
	...
	var appConfig = __webpack_require__(348);
	var allConfigs = {
		app: appConfig
	};
	...
	for (var i in appConfig.configs) {
		...
		allConfigs[appConfig.configs[i]] = __webpack_require__(349)("./" + appConfig.configs[i]);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extensionsDb = __webpack_require__(9);
	...
	var App = (function () {
		function App(config, node) {
			...
			this.router = new _Router2['default']({ context: this.context, node: node });
			this.router.start();
		}
	  ...
	  */
				...
				for (var i in data.config.storages) {
					for (var a in data.config.storages[i].api) {
						if (!this._api[data.config.storages[i].api[a]]) {
							var ApiClass = __webpack_require__(11)("./" + data.config.storages[i].api[a]);
	   ...
	   */
			...
			value: function createStore(name, data, options, apiList) {
				var StorageClass = __webpack_require__(39)("./" + name);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coreBaseApi = __webpack_require__(37);

	var _coreBaseApi2 = _interopRequireDefault(_coreBaseApi);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extensionsEvents = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./App": 40,
		"./App.js": 40,
		"./models/TestModel": 354,
		"./models/TestModel.js": 354,
		"./models/User": 43,
		"./models/User.js": 43
	};
	function webpackContext(req) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coreBaseStorage = __webpack_require__(41);

	var _coreBaseStorage2 = _interopRequireDefault(_coreBaseStorage);

	var _storagesModelsUser = __webpack_require__(43);
	...
	var AppStorage = (function (_BaseStorage) {
		...
		function AppStorage(data, options, db) {
			_classCallCheck(this, AppStorage);

			_get(Object.getPrototypeOf(AppStorage.prototype), 'constructor', this).call(this, data, options, db);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coreBaseModel = __webpack_require__(42);

	var _coreBaseModel2 = _interopRequireDefault(_coreBaseModel);
